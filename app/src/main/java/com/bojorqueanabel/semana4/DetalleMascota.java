...
public class DetalleMascota extends AppCompatActivity {
    ...
    public void inicializarListaContactos () {
        ...
        mascotas.add(new Mascota(R.drawable.perro1, "CeCe", "0"));
        mascotas.add(new Mascota(R.drawable.perro2, "Cody", "0"));
        mascotas.add(new Mascota(R.drawable.perro3, "Nina", "0"));
        mascotas.add(new Mascota(R.drawable.perro4, "JJ", "0"));
        mascotas.add(new Mascota(R.drawable.perro5, "Bella", "0"));
    }
